...
## 📱 Mobile Rules (Quick Reference)

- **Text**: `text-2xl md:text-3xl lg:text-4xl` (responsive)
- **Padding**: `p-4 md:p-6 lg:p-8` (responsive)
- **Grids**: `grid-cols-1 sm:grid-cols-2 md:grid-cols-3` (start with 1)
- **Buttons**: `size="sm"` (mobile-friendly)
