...
```
┌─────────────────────────────────────────────────────────────┐
│  1. Clarity From Profile (Neon Cyan #00FFFF)                │
│     ┌────────────────────────────────────────────────────┐  │
│     │ 💎 What's Going Well                               │  │
│     │ clarity_[key] content...                           │  │
│     │                                                    │  │
...
┌─────────────────────────────────────────────────────────────┐
│  2. Contrast from Profile (Neon Red #FF0040)                │
│     ┌────────────────────────────────────────────────────┐  │
│     │ ⚠️ What's Not Working                              │  │
│     │ contrast_[key] content...                          │  │
│     │                                                    │  │
...
┌─────────────────────────────────────────────────────────────┐
│  3. Clarity from Contrast (Premium Purple #BF00FF)          │
│     ┌────────────────────────────────────────────────────┐  │
│     │ 🔮 AI-Generated Clarity (from your contrast)       │  │
│     │ [Auto-generated by VIVA from contrast + worry]     │  │
│     │                                                    │  │
│     │ "Based on your contrast about X, the clarity is   │  │
│     │ that you value Y and desire Z..."                  │  │
│     └────────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────────┘
```
...
>
  ...
  {clarityText && (
    <div className="mb-4">
      <p className="text-xs text-[#00FFFF]/70 mb-1">💎 What's Going Well</p>
  ...
  {dreamText && (
    <div>
      <p className="text-xs text-[#00FFFF]/70 mb-1">✨ Your Dreams</p>
...
>
  ...
  {contrastText && (
    <div className="mb-4">
      <p className="text-xs text-[#FF0040]/70 mb-1">⚠️ What's Not Working</p>
  ...
  {worryText && (
    <div>
      <p className="text-xs text-[#FF0040]/70 mb-1">😰 Your Worries</p>
...
>
  ...
  {clarityFromContrast ? (
    ...
    <div className="space-y-2">
      <p className="text-neutral-400 text-sm">
        🔮 VIVA will automatically generate clarity from your contrast and worries.
      </p>
...
1. ✅ Add new colors to `src/lib/design-system/tokens.ts`:
   ```typescript
   neon: {
     cyan: '#00FFFF',
     red: '#FF0040'
...
2. ✅ Create `ProfileClarityCard.tsx`
3. ✅ Create `ProfileContrastCard.tsx`
4. ✅ Create `ClarityFromContrastCard.tsx`

### Phase 2: Data Loading

5. ✅ Update `/category/[key]/page.tsx` to load all 4 fields
6. ✅ Add state management for clarity, dream, contrast, worry
7. ✅ Display the 3 cards in the UI

### Phase 3: VIVA Integration

8. ✅ Update `src/lib/viva/prompts/clarity-prompt.ts` to include all fields
9. ✅ Update `/api/viva/clarity/route.ts` to pass all context
10. ✅ Update assembly prompt to include all profile data

### Phase 4: Contrast Flip

11. ✅ Create `/api/viva/contrast-flip/route.ts`
12. ✅ Add "Flip Contrast" button to Contrast card
13. ✅ Store result in `life_vision_category_state.clarity_from_contrast`

### Phase 5: Testing

14. ✅ Test with profiles that have all fields populated
15. ✅ Test with profiles that have some fields missing
16. ✅ Test contrast flip functionality
17. ✅ Verify colors render correctly
...
✅ **Richer Context** - VIVA knows aspirations AND concerns  
✅ **Visual Clarity** - Color-coded cards make it easy to understand  
✅ **Contrast Transformation** - Turn worries into clarity  
✅ **Premium Feature** - Purple card signals AI magic  
✅ **Comprehensive Understanding** - All 4 data points per category
