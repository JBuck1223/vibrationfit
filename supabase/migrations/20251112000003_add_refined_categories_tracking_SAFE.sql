-- EXTRA SAFE VERSION: Add refined_categories tracking to vision_versions
...
-- - DROP TRIGGER is safe (immediately recreated, no data loss)
-- - No columns are dropped
-- - No data is modified or deleted

-- ============================================================================
-- STEP 1: Add Column (Additive Only)
-- ============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    AND column_name = 'refined_categories'
  ) THEN
    ALTER TABLE vision_versions 
    ADD COLUMN refined_categories JSONB DEFAULT '[]'::jsonb;
    
    RAISE NOTICE 'Added refined_categories column';
  ELSE
    RAISE NOTICE 'Column refined_categories already exists, skipping';
  END IF;
END $$;

-- ============================================================================
-- STEP 2: Add Index (Additive Only)
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Add Column Comment (Additive Only)
-- ============================================================================
...
-- ============================================================================
-- STEP 4: Create/Update Trigger Function (No Data Loss)
-- ============================================================================
...
-- ============================================================================
-- STEP 5: Create/Update Trigger (Safe: Recreates if Exists)
-- ============================================================================

-- Drop trigger if exists (SAFE: No data loss, immediately recreated)
-- This is the standard PostgreSQL pattern for updating triggers
