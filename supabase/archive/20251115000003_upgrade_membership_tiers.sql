...
-- ============================================================================
-- Migration: 20251115000003_upgrade_membership_tiers.sql
-- Description: Add missing fields, clean up legacy fields, seed all plans
-- Prerequisite: 20251115000002_add_membership_tier_enum_values.sql (must run first)
-- ============================================================================
...
-- ============================================================================
-- STEP 2: DROP LEGACY/DUPLICATE FIELDS
-- ============================================================================
...
DROP POLICY IF EXISTS "Active membership tiers are viewable by everyone" ON membership_tiers;
DROP POLICY IF EXISTS "Only service role can modify membership tiers" ON membership_tiers;
