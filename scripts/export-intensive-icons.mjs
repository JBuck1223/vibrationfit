...
const ICONS = [
  ...
  { step: '04', name: 'eye', label: 'Build Your Life Vision', path: 'eye' },
  { step: '05', name: 'audio-lines', label: 'Generate Vision Audio', path: 'audio-lines' },
  { step: '06', name: 'mic', label: 'Record Your Voice', path: 'mic' },
  { step: '07', name: 'music', label: 'Create Audio Mix', path: 'music' },
  { step: '08', name: 'layout-grid', label: 'Create Vision Board', path: 'layout-grid' },
  { step: '09', name: 'pen-line', label: 'First Journal Entry', path: 'pen-line' },
  { step: '10', name: 'message-circle', label: 'First Vibe Tribe Post', path: 'message-circle' },
  { step: '11', name: 'users', label: 'Engage in Vibe Tribe', path: 'users' },
  { step: '12', name: 'dumbbell', label: 'Alignment Gym Tour', path: 'dumbbell' },
