-- Apply VIVA Conversations Table to Production
-- This creates the viva_conversations table for storing conversation context
...
BEGIN
    IF NOT EXISTS (
        ...
        AND tablename = 'viva_conversations' 
