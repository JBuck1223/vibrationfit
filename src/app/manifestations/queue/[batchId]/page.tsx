...
export default function VisionBoardQueueBatchPage() {
  ...
  const updateVisionBoardIdeasTracking = async (items: QueueItem[]) => {
    try {
      ...
      console.error('Error updating manifestation ideas tracking:', err)
    }
  }
  ...
  const handleViewBoard = () => {
    router.push(isIntensivePath ? '/intensive/vision-board' : '/manifestations')
  }
    ...
    return (
      <Container size="xl">
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4">
          ...
          <Button onClick={() => router.push('/manifestations/queue')} variant="primary">
            Back to queue
          </Button>
        </div>
      </Container>
      ...
      <Container size="xl">
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-6">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Button onClick={() => router.push('/manifestations/ideas')} variant="outline">
              Go to VIVA Ideas
            </Button>
          </div>
        </div>
        ...
        <div className="rounded-2xl border-2 border-[#333] bg-[#1F1F1F] p-6 md:p-8">
          <div className="text-center space-y-3">
            ...
            <h1 className="text-xl font-semibold text-white">
              {allComplete
                ? (totalCount === 1 ? 'Manifestation Created' : 'Manifestations Created')
                : (totalCount === 1
                    ? 'Creating Your Manifestation'
                    : 'Creating Your Manifestations')}
            </h1>
            <p className="text-sm text-neutral-400 max-w-md mx-auto">
              {allComplete
                ? `Successfully added ${completedCount} item${completedCount === 1 ? '' : 's'} to your board.`
                : (totalCount === 1
        ...
        {allComplete && (
          <div className="rounded-2xl border border-primary-500/20 bg-primary-500/5 p-6 text-center space-y-4">
            <p className="text-sm text-neutral-300">
              {completedCount === 1
                ? '1 manifestation has been created and added to your board.'
                : `${completedCount} manifestations have been created and added to your board.`}
              {errorCount > 0
                ? (errorCount === 1
                    ? ' 1 item had an error.'
            ...
            <div className="flex gap-3 justify-center">
              ...
              <Button onClick={() => router.push(isIntensivePath ? '/intensive/vision-board/ideas' : '/manifestations/ideas')} variant="outline">
                Add More Ideas
              </Button>
            </div>
          </div>
