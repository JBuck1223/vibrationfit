...
function VisionBoardQueueIndexContent() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      if (legacy) {
        router.replace(`/manifestations/queue/${encodeURIComponent(legacy)}`)
        return
      }
      ...
      if (active) {
        router.replace(`/manifestations/queue/${active.id}`)
        return
      }
          ...
          <Card className="p-6">
            <Stack gap="md" className="text-center">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <Button onClick={() => router.push('/manifestations/ideas')} variant="primary">
                  Go to VIVA Ideas
                </Button>
                <Button onClick={() => router.push('/manifestations')} variant="outline">
          ...
          <Card className="p-4 sm:p-6">
            <Stack gap="md">
              ...
              <ul className="space-y-2">
                {batches.map((b) => (
                  <li key={b.id}>
                    <button
                      type="button"
                      onClick={() => router.push(`/manifestations/queue/${b.id}`)}
              ...
              <div className="flex flex-wrap gap-3 justify-center pt-2">
                <Button onClick={() => router.push('/manifestations/ideas')} variant="primary" size="sm">
                  New batch from VIVA Ideas
                </Button>
                <Button onClick={() => router.push('/manifestations')} variant="outline" size="sm">
                  View my manifestations
                </Button>
              </div>
            </Stack>
