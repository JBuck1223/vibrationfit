...
export default function VisionBoardIdeasPage() {
  ...
  const handleAddToBoard = async () => {
    ...
    try {
      ...
      const basePath = isIntensivePath ? '/intensive/vision-board/queue' : '/manifestations/queue'
        ...
        <div className="relative min-h-[70vh]">
          <VIVALoadingOverlay
            ...
            messages={[
              ...
              "Crafting personalized manifestation ideas...",
        ...
        <Stack gap="lg">
          ...
          <Card variant="outlined" className="bg-[#101010] border-[#1F1F1F] p-6 md:p-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <Button onClick={() => router.push('/manifestations')} variant="ghost">
