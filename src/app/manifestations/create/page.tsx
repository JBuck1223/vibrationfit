...
const CREATE_TILES: CreateTile[] = [
  {
    title: 'Add New Item',
    description: 'Manually create a new manifestation with your own image and description.',
    icon: Plus,
  ...
  {
    title: 'VIVA Ideas',
    description: 'Let VIVA generate personalized manifestation ideas based on your Life Vision categories.',
    icon: Sparkles,
    iconColor: 'text-[#BF00FF]',
    iconBg: 'bg-[#BF00FF]/15',
    hoverBg: 'hover:bg-[#BF00FF]/[0.11]',
    href: '/manifestations/ideas',
  },
  {
    title: 'Generation Queue',
    description: 'Track the progress of VIVA-generated manifestations being created.',
    icon: Clock,
    iconColor: 'text-purple-400',
    iconBg: 'bg-purple-500/15',
    hoverBg: 'hover:bg-purple-500/[0.11]',
    href: '/manifestations/queue',
  },
]
