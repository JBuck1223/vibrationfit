...
export const DESIGN_SYSTEM_COMPONENTS: ComponentMetadata[] = [
  // Layout Primitives
  {
    ...
    icon: Layout,
    exportName: 'Stack',
    path: '/experiment/design-system/component/stack'
  },
  {
    id: 'inline',
    name: 'Inline',
    ...
    icon: GridIcon,
    exportName: 'Inline',
    path: '/experiment/design-system/component/inline'
  },
  {
    id: 'grid',
    name: 'Grid',
    ...
    icon: GridIcon,
    exportName: 'Grid',
    path: '/experiment/design-system/component/grid'
  },
  {
    id: 'two-column',
    name: 'Two Column',
    ...
    path: '/experiment/design-system/component/two-column'
  },
  {
    id: 'four-column',
    name: 'Four Column',
    ...
    path: '/experiment/design-system/component/four-column'
  },
  {
    id: 'switcher',
    name: 'Switcher',
    ...
    icon: GridIcon,
    exportName: 'Switcher',
    path: '/experiment/design-system/component/switcher'
  },
  {
    id: 'cover',
    name: 'Cover',
    ...
    icon: Square,
    exportName: 'Cover',
    path: '/experiment/design-system/component/cover'
  },
  {
    id: 'frame',
    name: 'Frame',
    ...
    icon: Square,
    exportName: 'Frame',
    path: '/experiment/design-system/component/frame'
  },
  {
    id: 'container',
    name: 'Container',
    ...
    path: '/experiment/design-system/component/container'
  },
  {
    id: 'page-layout',
    name: 'Page Layout',
    ...
    path: '/experiment/design-system/component/page-layout'
  },
  ...
  // UI Components
  {
    ...
    icon: Square,
    exportName: 'Card',
    path: '/experiment/design-system/component/card'
  },
  {
    id: 'button',
    name: 'Button',
    ...
    icon: MousePointer,
    exportName: 'Button',
    path: '/experiment/design-system/component/button'
  },
  {
    id: 'viva-button',
    name: 'VIVA Button',
    ...
    path: '/experiment/design-system/component/viva-button'
  },
  {
    id: 'icon',
    name: 'Icon',
    ...
    icon: Square,
    exportName: 'Icon',
    path: '/experiment/design-system/component/icon'
  },
  {
    id: 'badge',
    name: 'Badge',
    ...
    icon: Tag,
    exportName: 'Badge',
    path: '/experiment/design-system/component/badge'
  },
  {
    id: 'input',
    name: 'Input',
    ...
    icon: Edit,
    exportName: 'Input',
    path: '/experiment/design-system/component/input'
  },
  {
    id: 'textarea',
    name: 'Textarea',
    ...
    icon: Edit,
    exportName: 'Textarea',
    path: '/experiment/design-system/component/textarea'
  },
  {
    ...
    path: '/experiment/design-system/component/auto-resize-textarea'
  },
  {
    id: 'select',
    name: 'Select',
    ...
    icon: Edit,
    exportName: 'Select',
    path: '/experiment/design-system/component/select'
  },
  {
    id: 'item-list-card',
    name: 'Item List Card',
    ...
    path: '/experiment/design-system/component/item-list-card'
  },
  {
    id: 'pricing-card',
    name: 'Pricing Card',
    ...
    path: '/experiment/design-system/component/pricing-card'
  },
  {
    id: 'offer-stack',
    name: 'Offer Stack',
    ...
    path: '/experiment/design-system/component/offer-stack'
  },
  {
    id: 'action-buttons',
    name: 'Action Buttons',
  ...
  // Feedback Components
  {
    ...
    icon: Activity,
    exportName: 'Spinner',
    path: '/experiment/design-system/component/spinner'
  },
  {
    id: 'progress-bar',
    name: 'Progress Bar',
    ...
    path: '/experiment/design-system/component/progress-bar'
  },
  ...
  // Media Components
  {
    ...
    icon: Play,
    exportName: 'Video',
    path: '/experiment/design-system/component/video'
  },
  {
    id: 'audio-player',
    name: 'Audio Player',
    ...
    path: '/experiment/design-system/component/audio-player'
  },
  {
    id: 'playlist-player',
    ...
    path: '/experiment/design-system/component/playlist-player'
  },
  ...
  // Typography
  {
    ...
    icon: Type,
    exportName: 'Heading',
    path: '/experiment/design-system/component/heading'
  },
  {
    id: 'text',
    name: 'Text',
    ...
    icon: FileText,
    exportName: 'Text',
    path: '/experiment/design-system/component/text'
  },
  {
    id: 'title',
    name: 'Title',
    ...
    icon: Type,
    exportName: 'Title',
    path: '/experiment/design-system/component/title'
  },
  {
    id: 'bulleted-list',
    name: 'Bulleted List',
    ...
    path: '/experiment/design-system/component/bulleted-list'
  },
  {
    id: 'ordered-list',
    name: 'Ordered List',
    ...
    path: '/experiment/design-system/component/ordered-list'
  },
  {
    id: 'list-item',
    name: 'List Item',
    ...
    icon: List,
    exportName: 'ListItem',
    path: '/experiment/design-system/component/list-item'
  },
  ...
  // Navigation
  {
    ...
    icon: PanelTop,
    exportName: 'Sidebar',
    path: '/experiment/design-system/component/sidebar'
  },
  {
    ...
    path: '/experiment/design-system/component/mobile-bottom-nav'
  },
  {
    id: 'sidebar-layout',
    name: 'Sidebar Layout',
    ...
    path: '/experiment/design-system/component/sidebar-layout'
  },
  ...
  // Special Components
  {
    ...
    icon: Monitor,
    exportName: 'Modal',
    path: '/experiment/design-system/component/modal'
  },
  {
    ...
    path: '/experiment/design-system/component/delete-confirmation-dialog'
  },
  {
    ...
    path: '/experiment/design-system/component/insufficient-tokens-dialog'
  },
  {
