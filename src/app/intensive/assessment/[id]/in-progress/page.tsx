...
export default function IntensiveAssessmentInProgressPage() {
  ...
  useEffect(() => {
    async function initialize() {
      ...
      try {
        ...
        setLoadError('Unable to load your assessment. Please return to the dashboard and try again.')
      } finally {
        setIsLoading(false)
      }
    }
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      router.push(`/intensive/assessment/${assessmentId}/results`)
    } catch (error) {
