...
export default function ProfileCompletePage() {
  ...
  const checkCompletion = async () => {
    try {
      ...
      if (checklist?.profile_completed && checklist.profile_completed_at) {
        setCompletedAt(checklist.profile_completed_at)
      } else {
  ...
  return (
    <IntensiveStepComplete
      ...
      successMessage="Your life profile is complete across all 12 categories. This forms the foundation for your personalized Life Vision."
