...
export default function VIVALifeVisionLandingPage() {
  ...
  const handleGetStarted = async () => {
    ...
    if (firstIncomplete) {
      router.push(`/life-vision/new/${firstIncomplete.key}`)
    } else {
    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div className="mx-auto w-full max-w-3xl space-y-6">
          ...
          <div className="flex flex-col gap-2 md:gap-4 justify-center items-center max-w-2xl mx-auto">
            {visionStatus === 'completed' ? (
              <Button variant="primary" size="sm" onClick={() => router.push('/life-vision')} className="w-full md:w-auto">
        ...
        <CategoryGrid
          ...
          onCategoryClick={(key: string) => router.push(`/life-vision/new/${key}`)}
          mode="completion"
