      ...
      case 'love':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_love, fieldKey: 'clarity_love', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_love, fieldKey: 'dream_love', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_love, fieldKey: 'contrast_love', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_love, fieldKey: 'worry_love', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'family':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_family, fieldKey: 'clarity_family', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_family, fieldKey: 'dream_family', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_family, fieldKey: 'contrast_family', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_family, fieldKey: 'worry_family', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'health':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_health, fieldKey: 'clarity_health', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_health, fieldKey: 'dream_health', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_health, fieldKey: 'contrast_health', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_health, fieldKey: 'worry_health', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'home':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_home, fieldKey: 'clarity_home', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_home, fieldKey: 'dream_home', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_home, fieldKey: 'contrast_home', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_home, fieldKey: 'worry_home', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'work':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_work, fieldKey: 'clarity_work', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_work, fieldKey: 'dream_work', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_work, fieldKey: 'contrast_work', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_work, fieldKey: 'worry_work', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'money':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_money, fieldKey: 'clarity_money', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_money, fieldKey: 'dream_money', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_money, fieldKey: 'contrast_money', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_money, fieldKey: 'worry_money', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'fun':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_fun, fieldKey: 'clarity_fun', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_fun, fieldKey: 'dream_fun', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_fun, fieldKey: 'contrast_fun', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_fun, fieldKey: 'worry_fun', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'travel':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_travel, fieldKey: 'clarity_travel', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_travel, fieldKey: 'dream_travel', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_travel, fieldKey: 'contrast_travel', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_travel, fieldKey: 'worry_travel', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'social':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_social, fieldKey: 'clarity_social', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_social, fieldKey: 'dream_social', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_social, fieldKey: 'contrast_social', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_social, fieldKey: 'worry_social', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'stuff':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_stuff, fieldKey: 'clarity_stuff', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_stuff, fieldKey: 'dream_stuff', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_stuff, fieldKey: 'contrast_stuff', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_stuff, fieldKey: 'worry_stuff', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'spirituality':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_spirituality, fieldKey: 'clarity_spirituality', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_spirituality, fieldKey: 'dream_spirituality', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_spirituality, fieldKey: 'contrast_spirituality', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_spirituality, fieldKey: 'worry_spirituality', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
      ...
      case 'giving':
        return (
          <div className="space-y-4">
            ...
            {renderField({ label: "What's going well?", value: profile.clarity_giving, fieldKey: 'clarity_giving', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Dreams', value: profile.dream_giving, fieldKey: 'dream_giving', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: "What's not working?", value: profile.contrast_giving, fieldKey: 'contrast_giving', type: 'story' }, showHighlight, isEditable)}
            {renderField({ label: 'Worries', value: profile.worry_giving, fieldKey: 'worry_giving', type: 'story' }, showHighlight, isEditable)}
          </div>
        )
