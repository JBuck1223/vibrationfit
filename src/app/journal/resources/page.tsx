            ...
            <Stack gap="lg">
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">
                    Typing your thoughts out gets them out of your head and into a form you can actually work with.
                  </p>
                </div>
              </Inline>
              ...
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">
                    If you don&apos;t feel like typing, you can record audio or video, and we&apos;ll transcribe it for you. You can also add photos or AI-generated images.
                  </p>
                </div>
              </Inline>
              ...
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">
                    You can tag entries with the same life categories as your Life Vision (Love, Money, Health, etc.). Over time, you&apos;ll start to see where you&apos;re growing the most.
                  </p>
                </div>
              </Inline>
            </Stack>
            ...
            <Stack gap="lg">
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">Don&apos;t edit yourself. This is private and judgment-free.</p>
                </div>
              </Inline>
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">Aim for a thought that feels a bit better, not instant perfection.</p>
                </div>
              </Inline>
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">Add at least one thing you appreciate before closing an entry.</p>
                </div>
              </Inline>
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">Revisit past entries monthly. See your growth and appreciate how far you&apos;ve come.</p>
                </div>
              </Inline>
              <Inline gap="sm" className="items-start flex-nowrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-neutral-300 leading-relaxed mt-1">Try &quot;What feels alive for me right now?&quot; or &quot;What&apos;s one thing that went right today?&quot;</p>
                </div>
              </Inline>
            </Stack>
          </Stack>
