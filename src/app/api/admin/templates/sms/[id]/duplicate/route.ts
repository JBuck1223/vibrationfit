/**
 * Duplicate SMS Template API
 * 
 * POST /api/admin/templates/sms/[id]/duplicate - Duplicate a template
 */
...
export async function POST(
  ...
  try {
    ...
    console.error('Error in POST /api/admin/templates/sms/[id]/duplicate:', error)
