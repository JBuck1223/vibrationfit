...
const FIELD_CATEGORIES: Record<string, string> = {
  ...
  clarity_love: 'relationships',
  contrast_love: 'relationships',
  ...
  // Stories (Life Vision - Clarity & Contrast for remaining categories)
  clarity_fun: 'stories',
  contrast_fun: 'stories',
  clarity_travel: 'stories',
  contrast_travel: 'stories',
  clarity_social: 'stories',
  contrast_social: 'stories',
  clarity_stuff: 'stories',
  contrast_stuff: 'stories',
  clarity_spirituality: 'stories',
  contrast_spirituality: 'stories',
  clarity_giving: 'stories',
  contrast_giving: 'stories',
