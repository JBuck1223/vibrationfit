...
const FIELD_CATEGORIES: Record<string, string> = {
  ...
  home_environment_story: 'location',
  
  // Relationships
  relationship_status: 'relationships',
  relationship_length: 'relationships',
  partner_name: 'relationships',
  romance_partnership_story: 'relationships',
  
  // Family
  has_children: 'family',
  number_of_children: 'family',
  children_ages: 'family',
  family_parenting_story: 'family',
  
  // Stories (Life Vision)
  fun_recreation_story: 'stories',
  travel_adventure_story: 'stories',
  social_friends_story: 'stories',
  possessions_lifestyle_story: 'stories',
  spirituality_growth_story: 'stories',
  giving_legacy_story: 'stories',
