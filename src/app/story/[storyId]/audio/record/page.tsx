        ...
        {existingRecording && (
          <Card className="p-4 md:p-6 lg:p-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="danger" size="sm" onClick={handleDeleteRecording} disabled={saving}>
            ...
            <AudioPlayer
              track={{
                id: 'story-recording',
                title: story?.title || 'Story Recording',
                artist: 'Your Voice',
          ...
          {!hasContent ? (
            <div className="text-center p-8 bg-neutral-800/30 border border-neutral-700 border-dashed rounded-lg">
              ...
              <Button asChild variant="primary">
                <Link href={`/story/${storyId}`}>Edit Story</Link>
              </Button>
            </div>
          ) : (
            <>
        ...
        <Card className="p-4 md:p-6 lg:p-8 bg-purple-500/5 border-purple-500/20">
          <div className="flex items-center gap-4">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/story/${storyId}/audio/generate`}>Generate AI Audio</Link>
            </Button>
          </div>
        </Card>
      </Stack>
