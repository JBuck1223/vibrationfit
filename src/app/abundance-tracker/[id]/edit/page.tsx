...
export default function AbundanceEditEntryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Container size="xl">
      <Stack gap="lg">
        <PageHero
          title="Edit Abundance Moment"
          subtitle="Update your abundance entry"
        >
          <div className="flex justify-center gap-2">
            ...
            <Button asChild variant="outline" size="sm" className="text-xs md:text-sm">
              <Link href="/abundance-tracker">Abundance Dashboard</Link>
            </Button>
          </div>
        </PageHero>
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {existingImageUrl && (imageSource === 'keep' || imageSource === null) && (
                <div className="mb-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                  <img
            ...
            <div className="border-t-2 border-[#333] pt-6 mt-6 flex flex-row gap-2 justify-end">
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push(`/abundance-tracker/${eventId}`)}
