...
// Page Hero Component Showcase Page
// Displays detailed information, examples, and props for the PageHero component

import { useRouter } from 'next/navigation'
import { useState } from 'react'
import { ArrowLeft, Code, Eye, Sparkles, Check, Copy } from 'lucide-react'
import {
  Card,
  Button,
  Stack,
...
import { PageHeroExamples } from './component-examples'
      ...
      <Stack gap="lg">
        ...
        <Card className="p-4 md:p-6">
          <Stack gap="md">
            ...
            <Stack gap="lg">
              {Object.entries(PageHeroExamples).map(([key, example]) => (
