...
/**
 * Green Line concept — VERSION 3.
 *
 * The hammock figure never read as human, so "above the line" is now a
 * leaping, arms-raised figure (free + joyful) — a clean, unmistakably human
 * pose that also mirrors the trapped/caged figure below as its opposite.
 * Caged + handcuffed figure (the keeper) and baked-in principles retained.
 */
...
export default function GreenLineV3Page() {
  return (
    <div className="min-h-screen bg-black py-16 md:py-24">
      <Container size="lg">
        {/* Version label */}
        <div className="mx-auto mb-4 max-w-3xl text-center">
          <span className="inline-block rounded-full border border-[#39FF14]/40 bg-[#39FF14]/10 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-[#39FF14]">
            Version 3 — Latest
          </span>
        </div>
