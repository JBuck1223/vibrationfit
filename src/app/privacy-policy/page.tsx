        ...
        <Card className="p-6 md:p-8">
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">4.3 Business Changes</h3>
              <p className="text-neutral-300">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-white mb-4">5. Children, Families, and Child-Specific Features</h2>
              <p className="text-neutral-300 mb-4">
                Vibration Fit includes features designed for families, including content and experiences created specifically for children.
              </p>
              <p className="text-neutral-300 mb-4">
                Accounts are created and managed by a parent or legal guardian. Any information related to a child is provided by the adult managing the account and is used solely to support the intended experience within the platform.
              </p>
              <p className="text-neutral-300 mb-4">
                We do not knowingly collect personal information directly from children outside of what is intentionally provided by a parent or guardian through their account.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-white mb-4">10. Third-Party Services</h2>
              <p className="text-neutral-300">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-white mb-4">11. International Data Transfers</h2>
              <p className="text-neutral-300">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-white mb-4">12. California Privacy Rights</h2>
              <p className="text-neutral-300 mb-4">
