...
export default function AudioMixerAdminPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      const variantData = {
        id: editingVariant ? editingVariant.id : formData.id.toLowerCase().replace(/\s+/g, '-'),
        name: formData.name,
        voice_volume: formData.voiceVolume,
        bg_volume: formData.bgVolume,
        background_track: formData.backgroundTrack || null
      }
  ...
  const handleEdit = (variant: Variant) => {
    ...
    setFormData({
      id: variant.id,
      name: variant.name,
      voiceVolume: variant.voice_volume,
      bgVolume: variant.bg_volume,
      backgroundTrack: variant.background_track || ''
    })
