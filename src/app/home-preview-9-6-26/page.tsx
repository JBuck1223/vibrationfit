...
import { InstallRunEvolve } from '@/components/marketing/home/graphics'
...
export default function HomePreview9626Page() {
  return (
    <div className={`${display.variable} -mx-4 -mt-6 overflow-x-clip sm:-mx-6 md:-mx-6 md:-my-12 md:overflow-x-visible lg:-mx-8 lg:-mt-8`} data-home="home-preview-9-6-26">
      ...
      <section className="border-t border-white/10">
        <Container size="xl" className="px-4 py-12 md:px-10 md:py-16 lg:py-20">
          <SectionMedia graphic={<OfferBuyBox />}>
            ...
            <p className="hp-display mt-5 text-left text-[1.45rem] leading-tight text-[#39FF14] md:text-[1.75rem]">
