...
import { PricingBlock } from '../home-preview/PricingBlock'
import { ReceiptsSection } from '../home-preview/ReceiptsSection'
import { HeroLayout } from '../home-preview/HeroLayout'
...
export default function HomePreview2Page() {
  return (
    <div className="-mt-6 md:-my-12 lg:-mt-8" data-preview="v15-lucide">
      ...
      <Section>
        <SectionMedia graphic={<AttentionSplit />}>
      ...
      <Section>
        <SectionMedia side="left" graphic={<CreationLoop />}>
      ...
      <Section>
        <SectionMedia graphic={<InstallRunEvolve />}>
      ...
      <Section>
        <SectionMedia side="left" graphic={<ReconnectLoop />}>
