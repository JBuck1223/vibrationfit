...
export const ONBOARDING_STEPS: JourneyStep<OnboardingStepId>[] = [
  ...
  },
  {
    ...
    description: 'Record your Life Vision aloud in your own voice. Optional.',
    phase: 'Vision',
    href: '/audio/record',
    viewHref: '/audio/record',
    doneWhen: 'You recorded a section, or skipped',
    actionLabel: 'Record My Voice',
    canSkip: true,
  },
  {
    id: 'tribe',
