...
export const INTAKE_QUESTIONS: IntakeQuestion[] = [
  ...
  },
  {
    ...
    questionPre: 'Do you feel empowered to get into consistent vibrational harmony with that vision?',
  ...
  },
  {
    ...
    hint: 'Put 1 if you don\'t have one.',
    min: 0,
    max: 10,
    showInPre: true,
    showInPost: true,
  ...
  },
  {
    ...
    questionPre: 'Do you feel equipped to capture your conscious creation journey?',
    questionPost: 'Do you feel equipped to capture your conscious creation journey?',
    min: 0,
    max: 10,
    showInPre: true,
    showInPost: true,
  ...
  },
  {
    ...
    type: 'rating',
    label: 'Vibe Tribe',
    questionPre: 'How connected are you to a community that supports your conscious creation journey?',
    questionPost: 'How connected are you to a community that supports your conscious creation journey?',
    min: 0,
    max: 10,
    showInPre: true,
    showInPost: true,
  ...
  },
  {
    ...
    questionPre: 'How clear is your daily plan for consciously creating your reality?',
    questionPost: 'How clear is your daily plan for consciously creating your reality?',
    min: 0,
    max: 10,
    showInPre: true,
    showInPost: true,
  ...
  },
  {
    ...
    type: 'rating',
    label: 'Alignment Gym',
    questionPre: 'How supported do you feel in your conscious creation journey when wobbles come up?',
    questionPost: 'How supported do you feel in your conscious creation journey when wobbles come up?',
    min: 0,
    max: 10,
    showInPre: true,
    showInPost: true,
  ...
  },
  {
    ...
    questionPost: 'What was your experience in completing the 72-Hour Activation Intensive?',
    showInPre: false,
    showInPost: true,
  },
  {
