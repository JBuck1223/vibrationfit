...
// ============================================================================
export const assessmentQuestionsV1: AssessmentCategory[] = [
  {
    category: 'fun',
...
// CATEGORY METADATA
// ============================================================================
export const categoryMetadataV1: Record<AssessmentCategoryType, { title: string; description: string }> = {
 ...
 */
export function getAllCategoriesV1(): string[] {
  const categories = new Set(assessmentQuestionsV1.map((cat: { category: string }) => cat.category))
  return Array.from(categories)
}

export default assessmentQuestionsV1