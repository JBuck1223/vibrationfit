...
// This is embedded directly for Edge Runtime compatibility

export const MASTER_ASSISTANT_KNOWLEDGE = `# VIVA Master Assistant - Complete Platform Knowledge Base
...
- **Scoring**: Each question scored 1-5 points, 35 max per category (5 points × 7 questions)
- **Green Line Thresholds**:
  - Above: 28+ points (80%+) per category - Thriving, aligned, empowered mindset
  - Transitioning: 21-27 points (60-79%) - Moving toward alignment
  - Below: <21 points (<60%) - Growth opportunities, contrast for clarity (NOT failure)
...
- **12 Category Stories**: Natural language descriptions for each life area (fun_story, health_story, etc.)
