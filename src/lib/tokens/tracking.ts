...
export interface TokenUsage {
  ...
  action_type: 'vision_generation' | 'vision_refinement' | 'blueprint_generation' | 'chat_conversation' | 'audio_generation' | 'image_generation' | 'transcription' | 'admin_grant' | 'admin_deduct' | 'subscription_grant' | 'trial_grant' | 'token_pack_purchase' | 'life_vision_category_summary' | 'life_vision_master_assembly' | 'life_vision_category_generation' | 'prompt_suggestions' | 'frequency_flip' | 'vibrational_analysis' | 'viva_scene_generation' | 'north_star_reflection' | 'voice_profile_analysis' | 'vision_board_ideas' | 'imagination_starter' | 'focus_story_generation' | 'incantation_generation' | 'spark_query_generation' | 'story_refinement' | 'song_lyrics_generation' | 'project_organize' | 'travel_parse' | 'song_music_generation' | 'song_stems_generation' | 'video_generation' | 'background_processing' | 'admin_tool' | 'life_explorer_lesson' | 'life_explorer_checkin' | 'life_explorer_wall_photo' | 'life_explorer_book' | 'life_explorer_sidekick' | 'life_explorer_compose' | 'manifestation_distill'
  model_used: string
  tokens_used: number
  input_tokens?: number
