    ...
    >
      ...
      >
        ...
        <span className="leading-snug">
          {nameDisplay ? `${nameDisplay} unlocked` : 'A friend unlocked'} <strong>$96 off</strong> for you &mdash; start the Activation Intensive for just <strong>$1</strong>.{!isOfferPage && ' \u2192'}
        </span>
      </a>
    </div>
  )
