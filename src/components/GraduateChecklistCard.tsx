...
import { CheckCircle, Circle, MapPin, Video, MessageCircle, Dumbbell, Music, FileText, BookOpen, Award } from 'lucide-react'
...
export function GraduateChecklistCard({ progress }: GraduateChecklistCardProps) {
  return (
    <Card className="relative overflow-hidden p-0 border-2 border-[#39FF14]/30">
      <div className="absolute inset-0 opacity-5 bg-[#39FF14]" />
